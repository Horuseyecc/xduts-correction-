...
\cs_new:Npn \__xdu_frontmatter:
  {
    ...
    \cleardoublepage
\fancypagestyle{abstractzh}{
  \fancyhf{}
  \fancyhead[CE,CO]{\__xdu_rm_family:\zihao{5}摘要}
  \fancyhead[LE,RO]{\__xdu_rm_family:\zihao{-5}\thepage}
  \renewcommand{\headrulewidth}{0.75pt}
}
\fancypagestyle{abstracten}{
  \fancyhf{}
  \fancyhead[CE,CO]{\__xdu_rm_family:\zihao{5}ABSTRACT}
  \fancyhead[LE,RO]{\__xdu_rm_family:\zihao{-5}\thepage}
  \renewcommand{\headrulewidth}{0.75pt}
}
\fancypagestyle{tocstyle}{
  ...
  \fancyhead[CE,CO]{\__xdu_lang_switch:nn { 目录 } { Contents }}%
  ...
  \renewcommand{\headrulewidth}{0.75pt}
    ...
    \group_begin:
      ...
      \__xdu_typeout_keywords:nNn
        { Keywords:\enspace} { \l__xdu_keywords_en_clist } { \__xdu_keywords_space: }
    \group_end:
    \cleardoublepage
    \pagestyle{plain}
